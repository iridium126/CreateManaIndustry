package com.iridium126.createtricks.content.items;
...
public final class KineticsSpellCoreItem {
	private static final ResourceLocation ID = CreateTricks.modLoc("kinetics_spell_core");
	...
	public static Item create(Item.Properties properties) {
		try {
			...
			CreateTricks.LOGGER.warn("Failed to create Trickster spell core item", t);
		}
