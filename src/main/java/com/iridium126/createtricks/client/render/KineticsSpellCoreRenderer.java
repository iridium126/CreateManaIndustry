package com.iridium126.createtricks.client.render;
...
public final class KineticsSpellCoreRenderer {
	private static final ResourceLocation TEXTURE = CreateTricks.modLoc("textures/block/kinetics_spell_core.png");
